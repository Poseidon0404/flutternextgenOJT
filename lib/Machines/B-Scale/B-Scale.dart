...
class BScaleScreen extends StatefulWidget {
  ...
  const BScaleScreen({Key? key, required this.username}) : super(key: key);

  @override
  _BScaleScreenState createState() => _BScaleScreenState();
}

class _BScaleScreenState extends State<BScaleScreen> {
